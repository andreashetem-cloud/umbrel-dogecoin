...
# never written into the repo or into litecoin.conf.
...
# "app-doge-litecoin-node-seed", so the interpolated form would produce a
# DIFFERENT identifier, a different derived password, and every wallet or miner
# pointed at this node would stop authenticating. The string is the contract.

export APP_LITECOIN_NODE_RPC_USER="umbrel"
...
export APP_LITECOIN_NODE_RPC_PASS="$(derive_entropy "env-app-doge-litecoin-node-seed-RPC_PASSWORD")"
export APP_LITECOIN_NODE_RPC_PORT="9332"
export APP_LITECOIN_NODE_P2P_PORT="9333"
